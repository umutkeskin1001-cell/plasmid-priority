...
- Strongest audited metric model: `sovereign_precision_priority` | ROC AUC `0.828` | AP `0.766`.
...
- Discovery shortlist agreement with the strongest audited metric model: top-25 overlap: `15/25`; top-50 overlap: `27/50`.
