...
def build_candidate_portfolio_table(
    ...
    *,
    ...
    keep_columns = [
        ...
        "graph_degree_centrality_norm",
        "graph_betweenness_centrality_norm",
        "graph_pagerank_norm",
        "graph_neighborhood_risk_norm",
...
def annotate_candidate_explanation_fields(frame: pd.DataFrame) -> pd.DataFrame:
    ...
    signal_specs = [
        ...
        ("graph_degree_centrality_norm", "graph_centrality"),
        ("graph_betweenness_centrality_norm", "graph_centrality"),
        ("graph_pagerank_norm", "graph_centrality"),
        ("graph_neighborhood_risk_norm", "graph_centrality"),
