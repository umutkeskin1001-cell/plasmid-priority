...
def build_recommendation_report(
    ...
    lines = [
        ...
        "**Baseline**: discovery_boosted  ",
        "**Discovery Candidates**: discovery_9f_source, discovery_boosted, discovery_12f_class_balanced",
        "",
        "---",
        "",
    ...
    lines.extend(
        [
            "### Baseline Reference",
            "",
            f"- **Model**: {baseline.get('model_name', 'discovery_boosted')}",
